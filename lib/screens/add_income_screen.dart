...
class _AddIncomeScreenState extends State<AddIncomeScreen> {
  ...
  Future<void> _handleSave() async {
    ...
    if (_selectedCategory == null) {
      AppNotifier.error(context, 'Choose a source');
      return;
    }
    ...
    try {
      ...
      if (!mounted) return;
      // Returning `true` tells the Dashboard to reload its data.
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text('Add income', style: Theme.of(context).textTheme.headlineMedium),
                ],
              ),
            ),
            Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Column(
                        children: [
                          Text('Amount', style: TextStyle(color: colors.textMuted, fontSize: 12)),
                          ...
                          IntrinsicWidth(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixText: 'Rs ',
                                prefixStyle: TextStyle(color: colors.positive, fontSize: 24),
                                hintText: '0',
                    ...
                    Text('SOURCE',
                        style: TextStyle(
                            color: colors.textMuted, fontSize: 12, fontWeight: FontWeight.w700)),
                    const SizedBox(height: 10),
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(DateFormat('d MMM yyyy').format(_selectedDate),
                                style: TextStyle(color: colors.textBody, fontSize: 14.5)),
                          ],
                        ),
                      ),
                    ),
